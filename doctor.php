        ...
        <form id="doctorForm" action="view.php" method="POST">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><textarea id="additionalInfo" name="additionalInfo" rows="4" cols="40" placeholder="Any additional details"></textarea></td>
                </tr>
            </table>
